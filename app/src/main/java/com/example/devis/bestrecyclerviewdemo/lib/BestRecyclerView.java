 ...
 * = =
 */
public class BestRecyclerView extends RecyclerView implements LoadFinishCallBack {
    ...
    public BestRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BestRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        isLoadingMore = false;
        setOnPauseListenerParams(null, true, true);
    }
    ...
    private class AutoLoadScrollListener extends OnScrollListener {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (getLayoutManager() instanceof LinearLayoutManager) {
                ...
                int totalItemCount = BestRecyclerView.this.getAdapter().getItemCount();
